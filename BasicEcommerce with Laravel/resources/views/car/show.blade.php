            ...
            <div class="car-details-content">
                ...
                <div class="car-details card">
                    <div class="flex items-center justify-between">
                        ...
                        @php
                            $isFavourited =
                                auth()->check() && auth()->user()->favouriteCars()->where('car_id', $car->id)->exists();
                        @endphp

                        <button class="btn-heart {{ $isFavourited ? 'is-favourited' : '' }}"
                            onclick="addToFavourite({{ $car->id }})"
                            aria-pressed="{{ $isFavourited ? 'true' : 'false' }}"
                            style="background: none; border: none; cursor: pointer;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="orange"
                                stroke-width="1.5" fill="{{ $isFavourited ? 'orange' : 'none' }}" width="22"
                                height="22">
                 ...
                 c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        ...
                        {{-- Show Edit button only if the logged-in user is the car owner --}}
