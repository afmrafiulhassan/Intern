                    ...
                    <div class="table-responsive">
                        <table class="table">
                                            ...
                                            <td>
                                                @if ($car->primaryImage)
                                                    <img src="{{ asset('storage/' . $car->primaryImage->image_path) }}"
                                                        alt="Car image" class="my-cars-img-thumbnail" />
                                                @else
                                                    <img src="/img/default-car.png" alt="No image"
                            ...
                            @else
                                <tbody>
                                    <tr>
                                        <td colspan="5" class="text-center p-large py-10">
                                            <h3>You don't have any cars yet</h3>
                                            <p class="text-muted mb-3">Start by adding your first car listing.</p>
